...
const MyDeckCard = ({ title }: MyDeckCardProps) => {
    return (
        <div className="card bg-base-100 w-56 h-60 shadow-md">
            <div className="card-body items-center space-y-4">
                <svg className="w-36 h-36 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
